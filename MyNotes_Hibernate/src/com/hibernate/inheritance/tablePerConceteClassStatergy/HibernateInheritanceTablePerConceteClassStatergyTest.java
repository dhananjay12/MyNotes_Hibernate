...
public class HibernateInheritanceTablePerConceteClassStatergyTest {
	public static void main(String[] args) {
		...
		SessionFactory sessionFactory = new Configuration().configure("/com/hibernate/inheritance/tablePerConceteClassStatergy/hibernate.cfg.xml").buildSessionFactory();
